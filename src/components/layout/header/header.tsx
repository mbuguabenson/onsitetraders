...
const AppHeader = observer(({ isAuthenticating: isInitialAuthenticating }: { isAuthenticating?: boolean }) => {
    const { isDesktop } = useDevice();
    const { isAuthorizing: isApiAuthorizing, activeLoginid, setIsAuthorizing, authData } = useApiBase();
    
    // Combine both loading states
    const isAuthorizing = isApiAuthorizing || isInitialAuthenticating;
